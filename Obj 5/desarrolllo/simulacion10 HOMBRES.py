...
class PLSSEMPredictiveAnalyzer:
    ...
    def __init__(self, output_dir=None):
        ...
        if output_dir is None:
            self.output_dir = r"C:\01 academico\001 Doctorado Economia UCAB\d tesis problema ahorro\01 TESIS DEFINITIVA\MODELO\resultados obj5_HOMBRES"
        else:
    ...
    def load_and_prepare_data(self, data_path, descriptive_path=None, group='Hah'):
        """
...
def main():
    ...
    data_paths = {
        'HMah': r"C:\01 academico\001 Doctorado Economia UCAB\d tesis problema ahorro\01 TESIS DEFINITIVA\MODELO\resultados obj5\DATA_CONSOLIDADA promedio HM .xlsx"
    }

    descriptive_paths = {
        'HMah': r"C:\01 academico\001 Doctorado Economia UCAB\d tesis problema ahorro\01 TESIS DEFINITIVA\MODELO\resultados obj5\descripiva HMah.xlsx"
    }
