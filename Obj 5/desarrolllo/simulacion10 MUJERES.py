...
Autor: Sistema Experto en Econometría y Economía Conductual
Fecha: 2025
...
class PLSSEMPredictiveAnalyzer:
    ...
    def generate_detailed_report(self, group):
        ...
        with open(filepath, 'w', encoding='utf-8') as f:
            ...
            f.write(
                f"  El modelo explica {main_r2*100:.2f}% de la varianza en comportamiento de ahorro.\n\n")
...
def main():
    ...
    data_paths = {
        'Hah': r"C:\01 academico\001 Doctorado Economia UCAB\d tesis problema ahorro\01 TESIS DEFINITIVA\MODELO\resultados obj5\DATA_CONSOLIDADA HOMBRES promedio H M .xlsx",
        'Mah': r"C:\01 academico\001 Doctorado Economia UCAB\d tesis problema ahorro\01 TESIS DEFINITIVA\MODELO\resultados obj5\DATA_CONSOLIDADA MUJERES promedio H M .xlsx"
    }

    descriptive_paths = {
        'Hah': r"C:\01 academico\001 Doctorado Economia UCAB\d tesis problema ahorro\01 TESIS DEFINITIVA\MODELO\resultados obj5\descripiva HOMBRES ahorradores.xlsx",
        'Mah': r"C:\01 academico\001 Doctorado Economia UCAB\d tesis problema ahorro\01 TESIS DEFINITIVA\MODELO\resultados obj5\descriptiva MUJERES ahorradores Mah.xlsx"
    }
    ...
    print("\nArchivos generados:")
    print("📊 Visualizaciones PNG de alta resolución")
    print("📄 Reportes detallados por grupo (TXT)")
    print("📋 Reporte comparativo entre grupos")
    print("\n✅ Sistema listo para análisis adicionales o replicación")
